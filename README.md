...
### Edge SDK 설치
- dist 폴더 내의 sdk 파일을 다운받고, 설치합니다.
- scp -P 40022 -r jovyan@sftp.lgebigdata.com:/nas001/projects/AIA/edge_sdk/edge_sdk-0.5-py3-none-any.whl ./
- pip install edge_sdk-0.5-py3-none-any.whl

### Edge SDK를 위한 config 파일을 생성
임의의 경로에 `emulator_config.yaml` 를 다음의 내용으로 생성합니다.

```
alo_dir: /home/gyulim.gu/projects/edge_sdk/alo #ALO 경로
...
edge_security_key: edge-sdk-emulator-{{user_id}}-{{number}} # Edge를 구분하는 고유키로 {{ }}의 내용을 작성하여 설정
...
```
    from edge_sdk.edge_app_emulator import EdgeAppEmulator
